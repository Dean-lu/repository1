    ...
    <div id="contactMain" ref="contactMain">    
        ...
        <div class="houseNotice">
            ...
            <p>
                ...
                <br/>
                （三）本协议签订后，由乙方出租该房屋的，乙方免收甲方出租居间费；非乙方（包含甲方本人或甲方委托中介及朋友）租出且租客与乙方签署《房屋使用合同》并向乙方交纳押金、租金及相关代收和服务费用的。
                <br/>
                （四）房屋首次租出、签约《房屋使用合同》后，由甲方、乙方和租客3方签署《房屋交接单》，办理房屋交接；退租收房由甲方委托乙方办理、以后租出时由乙方直接办理房屋交接。
                <br/>                
            </p>
            <p>（五）甲方选择下列第<span></span>项由乙方提供的租后服务：</p>
            <p>
                ...
                3、购买1980元/套“出租房安全包”——密码锁1把、网关1个、消防箱1座、灭火器1个、无线烟感器1座、逃生绳1把、防毒面具2个、手电筒1个、太平洋《租房全能险》1份、出租警示标语17份。（注：不要密码锁的，为1480元/套）<br/>
                 4、购买“15元/月·套的太平洋《租房全能险》”——以甲方为受益人购买的房屋出租保险。<br/>
                 5、智能门锁（含网关）：“1050元/套”，包安装智能门锁提供便捷服务。
            </p>
        ...
        <div>
            <h2>四、违约责任：</h2>
            <p>
                （一）委托期内，甲方不得提前解约，否则甲方应双倍退还乙方以往已支付过的所有出租居间费、押金、退还已收但未发生的租金，承担应支付给租客提前解约的违约金。<br/>
