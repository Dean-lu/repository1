    ...
    <div id="contactMain" v-if="status=='start'">    
        ...
        <div class="houseNotice">
            ...
            <p>
                ...
                2、房间用电为智能独立电表，水表和燃气表（部分公寓使用燃气）均为共用；公摊水费30元/月/间，公摊燃气30元/月/间，该费用随房租一起缴纳，；电费（含公摊电费）按实结算，计算方式为：实际使用度数×1.00元/度（由上海蜂电<a href="tel:4009908619">4009908619</a>提供用电服务和咨询）。                            
            </p>                      
        </div>  
        <div>
            <h2>四、房屋使用重要说明</h2>
            <p>
                ...
                13、乙方如不满意甲方的服务，可以打电话<a href="tel:4001670731">4001670731</a>投诉，但不得进行不实传播，由此给甲方造成恶劣影响和损失的，甲方保留追究乙方法律责任的权利。                
            </p>
        </div>
        <div>
            <h2>五、特别约定</h2>
