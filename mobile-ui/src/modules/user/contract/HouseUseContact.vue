...
<div class="main">
    ...
    <div class="listConter" v-if="status=='end'">
      <img class="face" src="data:image/png;base64," alt="">
           <p class="tips">{{tips}}</p>
          <button  @click="paySign" class="btnOrange" v-if="btnstatus=='enter'">点击签名</button> 
    </div>
...
.mihua-logo{
 ...
 .listConter img{width:22%;margin:2.5rem auto 0.4rem auto;}
  .tips{text-align: center; color:#666; font-size: 0.5rem; width:80%;margin:0.2rem auto;}
 .cancvas-btn button{
      margin-bottom: 20px;
      font-size: 0.4rem;
      padding: 0 0.4rem;
